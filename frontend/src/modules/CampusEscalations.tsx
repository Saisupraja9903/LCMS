...
export default function CampusEscalations() {
  ...
  return <div className="fade-in campus-head-page campus-workspace escalation-workspace">
    <header className="campus-workspace-header"><div><span className="eyebrow">Campus / Branch Head</span><h1>Escalations</h1><p>Campus-scoped matters routed by authority policy.</p></div><button className="btn btn-crimson" onClick={() => setCreating(true)}>Create escalation</button></header>
